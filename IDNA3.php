...
class Net_IDNA3
{
     ...
     *
     * @see Net_IDNA3::$_mb_string_overload
     */
    ...
    function singleton($params = array())
    {
        ...
        if (!isset($instances[$signature])) {
            $instances[$signature] = Net_IDNA3::getInstance($params);
        }
